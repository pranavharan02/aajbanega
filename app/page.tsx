    ...
    <div className="landing-page">
      ...
      <div className="text-center pt-8 pb-12">
        ...
        <div
          ...
          style={{ maxWidth: '340px', animation: 'heroIn 0.7s cubic-bezier(0.16,1,0.3,1) both' }}
        >
          {/* WA header */}
          <div className="flex items-center gap-3 px-4 py-2.5" style={{ background: '#075E54' }}>
            ...
            <div className="w-9 h-9 rounded-full bg-[#DFE5E7] flex items-center justify-center text-[14px]">👩‍🍳</div>
            <div className="text-left">
              <div className="text-white text-[15px] font-medium leading-tight">Didi (Cook)</div>
          ...
          <div className="px-3 py-3 space-y-1.5" style={{ background: '#ECE5DD', backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'200\' height=\'200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'%23c6bfb5\' fill-opacity=\'0.15\'%3E%3Cpath d=\'M20 10c0-5.5-4.5-10-10-10S0 4.5 0 10s4.5 10 10 10 10-4.5 10-10zm-18 0c0-4.4 3.6-8 8-8s8 3.6 8 8-3.6 8-8 8-8-3.6-8-8z\'/%3E%3C/g%3E%3C/svg%3E")' }}>
            ...
            {/* Incoming: Didi */}
            <div className="flex justify-start" style={{ animation: 'msgIn 0.4s cubic-bezier(0.16,1,0.3,1) 0.3s both' }}>
              <div className="relative rounded-lg rounded-tl-sm px-3 py-1.5 shadow-sm" style={{ background: '#FFFFFF', maxWidth: '80%' }}>
                <p className="text-[15px] text-[#111B21]">aaj kya banaun? 🍳</p>
            ...
            {/* Typing indicator (outgoing — user still composing) */}
            <div className="flex justify-end" style={{ animation: 'msgIn 0.4s cubic-bezier(0.16,1,0.3,1) 1.1s both' }}>
              <div className="rounded-lg rounded-tr-sm px-4 py-3 shadow-sm" style={{ background: '#D9FDD3' }}>
                <div className="flex gap-1 items-center">
                  <div className="w-2 h-2 rounded-full bg-[#8696A0] animate-bounce" style={{ animationDelay: '0s', animationDuration: '1.4s' }} />
                  <div className="w-2 h-2 rounded-full bg-[#8696A0] animate-bounce" style={{ animationDelay: '0.2s', animationDuration: '1.4s' }} />
                  <div className="w-2 h-2 rounded-full bg-[#8696A0] animate-bounce" style={{ animationDelay: '0.4s', animationDuration: '1.4s' }} />
                </div>
              </div>
            </div>
          </div>
        ...
        <p
          className="text-[20px] text-[#8C8680] leading-relaxed max-w-sm mx-auto mt-8 mb-8"
